...
public class ApiController extends BaseController {
	...
	public Object getHospitalSet(ModelMap model,RedirectAttributes redirectAttributes) {
	...
	public Object getHospital(ModelMap model, HttpServletRequest request, RedirectAttributes redirectAttributes) {
		try {
			HospitalSet hospitalSet = hospitalSetMapper.selectById(1);
